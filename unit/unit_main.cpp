...
int unit_main(int argc, char** argv) 
{
	...
	if (SECTION & _PAIR_)
	{
		...
		check_pair<char, unsigned long long>();

		check_pair<int, char>();
		check_pair<int, int>();
		check_pair<int, long>();
		check_pair<int, long long>();
		...
		check_pair<int, unsigned long long>();

		check_pair<long, char>();
		check_pair<long, int>();
		check_pair<long, long>();
		check_pair<long, long long>();
		...
		check_pair<long, unsigned long long>();

		check_pair<long long, char>();
		check_pair<long long, int>();
		check_pair<long long, long>();
		check_pair<long long, long long>();
		check_pair<long long, float>();
		check_pair<long long, double>();
		check_pair<long long, unsigned char>();
		check_pair<long long, unsigned int>();
		check_pair<long long, unsigned long>();
		check_pair<long long, unsigned long long>();

		check_pair<float, char>();
		check_pair<float, int>();
		check_pair<float, long>();
		check_pair<float, long long>();
		...
		check_pair<unsigned long, unsigned long long>();

		check_pair<unsigned long long, char>();
		check_pair<unsigned long long, int>();
		check_pair<unsigned long long, long>();
		check_pair<unsigned long long, long long>();
		check_pair<unsigned long long, float>();
		check_pair<unsigned long long, double>();
		check_pair<unsigned long long, unsigned char>();
		check_pair<unsigned long long, unsigned int>();
		check_pair<unsigned long long, unsigned long>();
		check_pair<unsigned long long, unsigned long long>();
	...
	if (SECTION & _ENABLE_IF_)
	{
		...
		check_enable_if<unsigned long long>();
	...
	if (SECTION & _ITERATOR_)
	{
		...
		check_iterator<unsigned long long>();
	...
	if (SECTION & _STACK_)
	{
		...
		check_stack<unsigned long long>();
	...
	if (SECTION & _MAP_B_)
	{
		...
		check_map<unsigned long long, char>();
		check_map<unsigned long long, int>();
		check_map<unsigned long long, float>();
		check_map<unsigned long long, double>();
		check_map<unsigned long long, unsigned char>();
		check_map<unsigned long long, unsigned int>();
	...
	if (SECTION & _MAP_E_)
	{
		...
		check_map<char, long long>();
		check_map<char, unsigned long long>();
		check_map<int, long long>();
		check_map<int, unsigned long long>();
		check_map<long, long long>();
		check_map<long, unsigned long long>();
		check_map<float, long long>();
		check_map<float, unsigned long long>();
		check_map<double, long long>();
		check_map<double, unsigned long long>();
	
// Kept lines below commented due to memory limitation.
//		check_map<unsigned char, long long>();
//		check_map<unsigned char, unsigned long long>();
//		check_map<unsigned int, long long>();
//		check_map<unsigned int, unsigned long long>();
//		check_map<unsigned long, long long>();
//		check_map<unsigned long, unsigned long long>();
//		check_map<unsigned long long, long>();
//		check_map<unsigned long long, long long>();
//		check_map<unsigned long long, unsigned long>();
//		check_map<unsigned long long, unsigned long long>();
//		check_map<long long, char>();
//		check_map<long long, int>();
//		check_map<long long, long>();
//		check_map<long long, long long>();
//		check_map<long long, float>();
//		check_map<long long, double>();
//		check_map<long long, unsigned char>();
//		check_map<long long, unsigned int>();
//		check_map<long long, unsigned long>();
//		check_map<long long, unsigned long long>();
	...
	if (SECTION & _EQ_LEXICO_)
	{
		...
		check_eq_lexico<char, long long>();
		check_eq_lexico<char, float>();
		check_eq_lexico<char, double>();
		check_eq_lexico<char, unsigned char>();
		check_eq_lexico<char, unsigned int>();
		check_eq_lexico<char, unsigned long>();
		check_eq_lexico<char, unsigned long long>();

		check_eq_lexico<int, char>();
		check_eq_lexico<int, int>();
		check_eq_lexico<int, long>();
		check_eq_lexico<int, long long>();
		check_eq_lexico<int, float>();
		check_eq_lexico<int, double>();
		check_eq_lexico<int, unsigned char>();
		check_eq_lexico<int, unsigned int>();
		check_eq_lexico<int, unsigned long>();
		check_eq_lexico<int, unsigned long long>();

		check_eq_lexico<long, char>();
		check_eq_lexico<long, int>();
		check_eq_lexico<long, long>();
		check_eq_lexico<long, long long>();
		check_eq_lexico<long, float>();
		check_eq_lexico<long, double>();
		check_eq_lexico<long, unsigned char>();
		check_eq_lexico<long, unsigned int>();
		check_eq_lexico<long, unsigned long>();
		check_eq_lexico<long, unsigned long long>();

		check_eq_lexico<long long, char>();
		check_eq_lexico<long long, int>();
		check_eq_lexico<long long, long>();
		check_eq_lexico<long long, long long>();
		check_eq_lexico<long long, float>();
		check_eq_lexico<long long, double>();
		check_eq_lexico<long long, unsigned char>();
		check_eq_lexico<long long, unsigned int>();
		check_eq_lexico<long long, unsigned long>();
		check_eq_lexico<long long, unsigned long long>();

		check_eq_lexico<float, char>();
		check_eq_lexico<float, int>();
		check_eq_lexico<float, long>();
		check_eq_lexico<float, long long>();
		check_eq_lexico<float, float>();
		check_eq_lexico<float, double>();
		check_eq_lexico<float, unsigned char>();
		check_eq_lexico<float, unsigned int>();
		check_eq_lexico<float, unsigned long>();
		check_eq_lexico<float, unsigned long long>();

		check_eq_lexico<double, char>();
		check_eq_lexico<double, int>();
		check_eq_lexico<double, long>();
		check_eq_lexico<double, long long>();
		check_eq_lexico<double, float>();
		check_eq_lexico<double, double>();
		check_eq_lexico<double, unsigned char>();
		check_eq_lexico<double, unsigned int>();
		check_eq_lexico<double, unsigned long>();
		check_eq_lexico<double, unsigned long long>();

		check_eq_lexico<unsigned char, char>();
		check_eq_lexico<unsigned char, int>();
		check_eq_lexico<unsigned char, long>();
		check_eq_lexico<unsigned char, long long>();
		check_eq_lexico<unsigned char, float>();
		check_eq_lexico<unsigned char, double>();
		check_eq_lexico<unsigned char, unsigned char>();
		check_eq_lexico<unsigned char, unsigned int>();
		check_eq_lexico<unsigned char, unsigned long>();
		check_eq_lexico<unsigned char, unsigned long long>();

		check_eq_lexico<unsigned int, char>();
		check_eq_lexico<unsigned int, int>();
		check_eq_lexico<unsigned int, long>();
		check_eq_lexico<unsigned int, long long>();
		check_eq_lexico<unsigned int, float>();
		check_eq_lexico<unsigned int, double>();
		check_eq_lexico<unsigned int, unsigned char>();
		check_eq_lexico<unsigned int, unsigned int>();
		check_eq_lexico<unsigned int, unsigned long>();
		check_eq_lexico<unsigned int, unsigned long long>();

		check_eq_lexico<unsigned long, char>();
		check_eq_lexico<unsigned long, int>();
		check_eq_lexico<unsigned long, long>();
		check_eq_lexico<unsigned long, long long>();
		check_eq_lexico<unsigned long, float>();
		check_eq_lexico<unsigned long, double>();
		check_eq_lexico<unsigned long, unsigned char>();
		check_eq_lexico<unsigned long, unsigned int>();
		check_eq_lexico<unsigned long, unsigned long>();
		check_eq_lexico<unsigned long, unsigned long long>();

		check_eq_lexico<unsigned long long, char>();
		check_eq_lexico<unsigned long long, int>();
		check_eq_lexico<unsigned long long, long>();
		check_eq_lexico<unsigned long long, long long>();
		check_eq_lexico<unsigned long long, float>();
		check_eq_lexico<unsigned long long, double>();
		check_eq_lexico<unsigned long long, unsigned char>();
		check_eq_lexico<unsigned long long, unsigned int>();
		check_eq_lexico<unsigned long long, unsigned long>();
		check_eq_lexico<unsigned long long, unsigned long long>();
