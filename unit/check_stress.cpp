...
/*   Updated: 2021/12/22 11:49:05 by fde-capu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	} std::cout << N << " vector swaps " << chrono << std::endl;
	...
	std::cout << chrono.start(); for (int i = 0; i < I; i++) {
		vv.push_back(rnd_vec<int>(I));
	} std::cout << I << "x" << I << " vector-of-vector " << chrono << std::endl;
